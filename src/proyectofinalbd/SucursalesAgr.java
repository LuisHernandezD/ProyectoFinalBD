 ...
 * @author LuFitz
 */
public class SucursalesAgr extends javax.swing.JFrame {

    /**
     * Creates new form SucursalesAgr
     */
    public SucursalesAgr() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        domicilioSuc = new javax.swing.JTextField();
        ...
        jLabel2.setText("Introduce el domicilio de la sucursal");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, -1, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel3.setText("Introduce el nombre de la sucursal");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 150, -1, -1));

        nombreSuc.setFont(new java.awt.Font("Tahoma", 2, 14)); // NOI18N
        nombreSuc.setToolTipText("");
        nombreSuc.setBorder(null);
        nombreSuc.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        jPanel1.add(nombreSuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, 330, -1));

        jSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 220, 240, -1));

        domicilioSuc.setFont(new java.awt.Font("Tahoma", 2, 14)); // NOI18N
        domicilioSuc.setBorder(null);
        domicilioSuc.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        jPanel1.add(domicilioSuc, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 320, 340, -1));
    ...
    public void AgregarSucursal() throws ClassNotFoundException, SQLException{
        ...
        String nombre = String.valueOf(nombreSuc.getText());
        String domicilio = String.valueOf(domicilioSuc.getText());
        Statement instruccion = con.createStatement();
        instruccion.execute("exec dbo.sucursalAgregar " + nombre + "," + domicilio );
    ...
    private javax.swing.JTextField domicilioSuc;
